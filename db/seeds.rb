...
user3 = User.create(email: 'email2@gmail.com', password: '123456', firstname: 'User', lastname: 'Last', gender: 'female', dob: '12/01/1980')

custom1 = Custom.create(user_id: 2,
